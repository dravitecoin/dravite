...
#if defined(NDEBUG)
# error "Dravite cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Dravite Signed Message:\n";
...
bool CBlock::AddToBlockIndex(unsigned int nFile, unsigned int nBlockPos, const uint256& hashProof)
{
	...
	pindexNew->nStakeModifier = ComputeStakeModifierV2(pindexNew->pprev, IsProofOfWork() ? hash : vtx[1].vin[0].prevout.hash);
...
#ifdef ENABLE_WALLET
// Dravite: attempt to generate suitable proof-of-stake
